 ...
 *   private final ActivityFlowSupport activityFlowSupport = new ActivityFlowSupport();
...
public final class ActivityFlowSupport {
  ...
  public void onCreate(NonConfigurationInstance nonConfigurationInstance, Bundle savedInstanceState,
      Parceler parceler, Backstack defaultBackstack) {
    if (nonConfigurationInstance != null) {
      this.flow = nonConfigurationInstance.flow;
      return;
    }
    checkState(flow == null, "Flow already created.");
    ...
    flow = new Flow(initialBackstack);
  }
